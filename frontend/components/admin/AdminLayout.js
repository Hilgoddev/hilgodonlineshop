    ...
    <>
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0 }}>
              ...
              <div style={{ minWidth: 0 }}>
                ...
                <p style={{ margin: '2px 0 0', fontSize: '0.78rem', color: '#64748b' }}>Signed in as {session?.user?.email}</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
              <Link href="/account" className="btn btn-outline btn-sm" style={{ fontSize: '0.82rem' }}>
                Profile
              </Link>
          ...
          <main style={{ flex: 1, padding: '22px 20px 40px', maxWidth: '1440px', width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
            {children}
          </main>
        </div>
      </div>
