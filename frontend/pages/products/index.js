...
export default function ProductsPage({ initialProducts, initialPagination }) {
  ...
  }, [selectedCategories, selectedSubcategories, sortBy]);
  ...
  const getCategoryBrands = () => {
    const brandMap = {
      ...
      accessories: ['Rolex', 'Casio', 'Ray-Ban', 'Michael Kors'],
      home: ['IKEA', 'ErgoDesk', 'Philips', 'HomeGoods'],
      kitchen: ['Binatone', 'Nasco', 'Panasonic', 'LG'],
      shoes: ['Nike', 'Adidas', 'Puma', 'Vans', 'New Balance']
    };
    return category && brandMap[category] ? brandMap[category] : ['Samsung', 'Apple', 'Nike', 'MAC', 'LG', 'Adidas'];
  };
        ...
        <div className="products-main">
          ...
          <div className="products-topbar">
            <div className="products-count">
              <strong id="product-count">{products.length}</strong> products found
            </div>
