...
const posts = [
  { slug: '#', category: 'Shopping Tips', title: 'How to Get the Best Deals on Hilgod', date: 'May 10, 2026', readTime: '3 min read', excerpt: 'Learn how to use filters, wishlist, and price alerts to never miss a great deal on Hilgod Online Store.' },
  { slug: '#', category: 'Sellers', title: 'Top 5 Tips to Grow Your Online Store on Hilgod', date: 'April 28, 2026', readTime: '5 min read', excerpt: 'Verified sellers share their secrets for driving more traffic, increasing conversion rates, and building loyal customers.' },
  { slug: '#', category: 'Delivery', title: 'Understanding Our Nationwide Delivery Network', date: 'April 15, 2026', readTime: '4 min read', excerpt: 'A behind-the-scenes look at how Hilgod delivers to all 36 states in Nigeria and beyond.' },
  { slug: '#', category: 'Security', title: 'How Hilgod Protects Your Payments', date: 'April 3, 2026', readTime: '3 min read', excerpt: 'Everything you need to know about our multi-layer payment security and buyer protection guarantees.' },
  { slug: '#', category: 'Products', title: 'The Best Electronics Launches of 2026 Available on Hilgod', date: 'March 22, 2026', readTime: '6 min read', excerpt: 'From foldable phones to AI-powered gadgets — the year\'s biggest tech releases are now on Hilgod.' },
  { slug: '#', category: 'Lifestyle', title: 'African Fashion Trends You Need to Know This Season', date: 'March 10, 2026', readTime: '4 min read', excerpt: 'Explore the boldest Afrocentric styles and where to find them on our platform.' },
];
