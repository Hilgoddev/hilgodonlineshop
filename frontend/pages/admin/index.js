    ...
    <>
      ...
      >
        {[
          ...
          { icon: 'fa-naira-sign', label: 'Revenue (paid/delivered)', value: `₦${stats.revenue.toLocaleString()}`, bg: '#ede9fe', clr: '#6d28d9' },
          { icon: 'fa-clipboard-check', label: 'Pending approvals', value: stats.pendingApprovals, bg: '#fee2e2', clr: '#b91c1c' },
        ].map((card, i) => (
          <div key={i} className="card" style={{ padding: '18px', display: 'flex', alignItems: 'center', gap: '14px' }}>
            ...
            <div>
              <p style={{ color: '#64748b', fontSize: '0.8rem', fontWeight: 600, margin: '0 0 4px' }}>{card.label}</p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 300px', gap: '20px', alignItems: 'start' }} className="admin-dash-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div className="card" style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <Link href="/admin/approvals" className="btn btn-outline" style={{ textAlign: 'center', fontSize: '0.86rem' }}>
                Pending approvals
              </Link>
              <Link href="/admin/products" className="btn btn-primary" style={{ textAlign: 'center', fontSize: '0.86rem' }}>
                Manage products
              </Link>
              <Link href="/admin/orders" className="btn btn-outline" style={{ textAlign: 'center', fontSize: '0.86rem' }}>
                All orders
              </Link>
            </div>
          </div>
