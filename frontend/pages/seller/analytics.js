        ...
        {loading ? (
          ...
          <>
            ...
            <div className="seller-metrics-grid" style={{ marginBottom: '24px' }}>
              <MetricCard icon="fa-naira-sign" label="Total Revenue" value={`₦${Number(data.metrics.totalSales || 0).toLocaleString()}`} />
              ...
              <MetricCard icon="fa-tag" label="Avg. List Price" value={`₦${Number(data.metrics.avgProductPrice || 0).toLocaleString()}`} />
            </div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px', gap: '8px', flexWrap: 'wrap' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
                            ...
                            <div style={{ textAlign: 'right' }}>
                              <div style={{ fontWeight: 800, color: 'var(--primary)', fontSize: '.95rem' }}>₦{product.sales.toLocaleString()}</div>
